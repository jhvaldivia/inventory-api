...
public class ProductRestControllerTest {
	...
	public void setup() throws Exception {
		...
		this.productList.add(productRepository.save(new Product("BBB00001", "Product 1",
				"This is a mock product description.", 4, Region.findByLabel("Aguascalientes"), productOrder)));
	}

	@Test
	public void createProduct() throws Exception {
		mockMvc.perform(post("/products/").content(this.json(new Product())).contentType(contentType))
